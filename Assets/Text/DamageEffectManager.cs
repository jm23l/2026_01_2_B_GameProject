...
public class DamageEffectManager : MonoBehaviour
{
    ...
    public void ShoweDamageText(Vector3 position, string text, Color color, bool isCritical = false,
        bool isStatusEffect = false)
    {
        ...
        GameObject damageText = Instantiate(textPrefabs, uiCanvas.transform);           // 데미지 텍스트 UI 생성
    ...
    public void ShowDamage(Vector3 position, int amount, bool isCritical = false)                   // 데미지 함수
    {
        ...
        ShoweDamageText(position, text, color, isCritical);
    }
    ...
    {
        ShoweDamageText(position, "MISS", Color.gray, false);
    }
    ...
    public void ShowStatusEffect(Vector3 position, string effectName)                       // 상태 효과 함수
    {
        ...
        ShoweDamageText(position, effectName.ToLower(), Color.gray , false);
    }
}
